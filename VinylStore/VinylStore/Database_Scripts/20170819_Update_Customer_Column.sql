...
ALTER TABLE Employees ALTER COLUMN FullName varchar(32)NULL;
...
ALTER TABLE Customers ALTER COLUMN FullName NVARCHAR(32) NULL;
...
ALTER TABLE LendVinyls ALTER COLUMN CustomerFullName NVARCHAR(32) NULL;
